...
| **Hermes Agent** | `@iflow-ai/search-mcp` server over stdio | Yes — `@iflow-ai/search-mcp@0.1.0-pre.2` on dist-tag `next` | ✅ Smoke green end-to-end — Hermes is the first verified MCP client. See Phase 3 verification record. | Hermes is an MCP client. A Hermes-specific package would lock us to Hermes' release cycle — rejected. | <https://modelcontextprotocol.io/> · <https://github.com/NousResearch/hermes-agent/issues/29250> |
